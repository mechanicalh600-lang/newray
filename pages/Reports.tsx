...
export const Reports: React.FC = () => {
  ...
  const getChartData = () => {
      ...
      // If the key doesn't exist in data items, fallback
      ...
      filteredData.forEach(item => {
          ...
          // Simplify date grouping
          if (typeof val === 'string' && (val.includes('/') || val.includes('-'))) {
             // Keep date as is or simplify? Usually date string is fine for grouping if normalized
          }
