...
import { SHIFT_TYPE_MAP, parseTimeToMinutes, getProductionTimes, THICKENER_TIMES } from '../../features/reports/presets/shift/ShiftHandoverTypes';
import { parseShamsiDate } from '../../utils';
import { exportElementToPdf, elementToPdfBlob } from '../../utils/pdfExport';
...
export const ShiftReportView: React.FC<ShiftReportViewProps> = ({ reportData, adminAvatar, onBack }) => {
    ...
    const handleDownloadPDF = async () => {
        ...
        try {
            await exportElementToPdf(element, fileNameLat);
        } catch (e) {
    ...
    const handleShareReport = async () => {
        ...
        try {
            const blob = await elementToPdfBlob(element, fileNameLat);
                            ...
                            <div className="flex-1 mt-3">
                                <ResponsiveContainer width="100%" height="100%">
                                    <BarChart data={barChartData} margin={{ top: 5, right: 5, left: -20, bottom: 0 }}>
                                        ...
                                        <XAxis dataKey="time" angle={-45} textAnchor="end" tick={{ fontSize: 8 }} interval={0} height={30} tickMargin={5} />
                    ...
                    <div className="h-48 bg-white border border-gray-200 rounded-xl p-2 mb-3 relative">
                        ...
                        <ResponsiveContainer width="100%" height="100%">
                            <LineChart data={barChartData} margin={{ top: 20, right: 10, left: -20, bottom: 0 }}>
                                ...
                                <XAxis dataKey="time" angle={-45} textAnchor="end" tick={{ fontSize: 9 }} height={40} />
