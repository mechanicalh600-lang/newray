...
import { Users, Factory, Activity, Magnet, Layers, Droplet, Recycle, StopCircle, Clipboard } from 'lucide-react';
...
export const TABS = [
    ...
    { id: 9, label: 'کارکرد و توقفات', icon: StopCircle },
    { id: 10, label: 'توضیحات', icon: Clipboard },
];
