...
const adminSubmenu = ORDERED_TABS.map(key => ({
  id: key,
  title: TABLE_LABELS[key],
  icon: FolderOpen, // Generic icon for admin entities
  path: `/admin/${key}`
}));
...
export const MENU_ITEMS = [
  ...
  { 
    ...
    submenu: [
      ...
      { id: 'ready-templates', title: 'قالب گزارش آماده', icon: FileText, path: '/ready-templates' },
