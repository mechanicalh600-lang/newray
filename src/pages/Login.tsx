...
export const Login: React.FC<LoginProps> = ({ onLogin }) => {
  ...
  // FIX: Using a valid UUID instead of "1" to prevent PostgreSQL 22P02 error
            ...
            {isResetMode ? (
                    ...
                    {resetSuccess ? (
                        ...
                        <>
                                ...
                                <div className="space-y-1">
                                    ...
                                    <div className="relative">
                                        ...
                                        <input
                                            ...
                                            className="w-full pr-9 pl-4 h-10 bg-gray-50 dark:bg-gray-900/50 border border-gray-200 dark:border-gray-600 rounded-2xl focus:ring-2 focus:ring-[#800020] focus:border-transparent outline-none text-sm transition-all"
                                            required
                                        />
                                    </div>
                                </div>
                                ...
                                <div className="space-y-1">
                                    ...
                                    <div className="relative">
                                        ...
                                        <input
                                            ...
                                            className={`w-full pr-9 pl-4 h-10 bg-gray-50 dark:bg-gray-900/50 border rounded-2xl focus:ring-2 focus:ring-[#800020] focus:border-transparent outline-none text-sm transition-all ${resetConfirmPass && !passwordsMatch ? 'border-red-500' : 'border-gray-200 dark:border-gray-600'}`}
                                            required
                                        />
                                        {resetConfirmPass && (
                            ...
                            <button 
                                ...
                                className="w-full bg-[#b91c1c] hover:bg-[#991b1b] text-white h-10 rounded-2xl font-bold text-sm transition-all transform active:scale-95 shadow-lg shadow-red-900/20 flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
                            >
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <div className="space-y-1">
                            ...
                            <div className="relative group">
                                ...
                                <input
                                    ...
                                    className="w-full pr-10 pl-4 h-12 bg-gray-50 dark:bg-gray-900/50 border border-gray-200 dark:border-gray-600 rounded-2xl focus:ring-2 focus:ring-[#800020] focus:border-transparent outline-none transition-all text-gray-800 dark:text-gray-100 text-sm"
                                    required
                        ...
                        <div className="space-y-1">
                            ...
                            <div className="relative group">
                                ...
                                <input
                                    ...
                                    className="w-full pr-10 pl-10 h-12 bg-gray-50 dark:bg-gray-900/50 border border-gray-200 dark:border-gray-600 rounded-2xl focus:ring-2 focus:ring-[#800020] focus:border-transparent outline-none transition-all text-gray-800 dark:text-gray-100 tracking-wider text-sm"
                    ...
                    <button
                        type="submit"
                        disabled={loading}
                        className="w-full bg-[#b91c1c] hover:bg-[#991b1b] text-white h-12 rounded-2xl font-bold text-sm transition-all transform active:scale-[0.98] shadow-xl shadow-red-900/20 flex items-center justify-center gap-2 mt-4 disabled:opacity-70 disabled:cursor-wait"
                    >
